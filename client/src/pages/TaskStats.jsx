  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center mb-2">
        <Link to="/dashboard" className="mr-4 text-primary-600 hover:text-primary-800">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
            <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
          </svg>
        </Link>
        <h1 className="text-2xl font-bold text-secondary-900">Task Statistics</h1>
      </div>
      
      <h2 className="text-xl font-semibold text-primary-600 mb-6">{taskData.task.title}</h2>
      ...
      <div className="bg-white rounded-lg shadow-card p-6 mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <div className="bg-primary-50 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-primary-600">{taskData.days_completed}</div>
            <div className="text-sm text-secondary-600">Days Completed</div>
          </div>
          
          <div className="bg-primary-50 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-primary-600">{Math.round(taskData.completion_rate)}%</div>
            <div className="text-sm text-secondary-600">Completion Rate</div>
          </div>
          
          <div className="bg-primary-50 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-primary-600">{taskData.current_streak}</div>
            <div className="text-sm text-secondary-600">Current Streak</div>
          </div>
        </div>
      ...
      {/* Completion chart */}
      <div className="bg-white rounded-lg shadow-card p-6 mb-8">
        <h3 className="text-lg font-semibold mb-6">Daily Completion History</h3>
      ...
      <div className="bg-white rounded-lg shadow-card p-6">
        <h3 className="text-lg font-semibold mb-4">Completion Log</h3>
